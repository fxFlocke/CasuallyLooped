...
export function TranslatePosition(pos: Position, widthBase: number, heightBase: number): Position {
  let translatedPos: Position = {
    x: ((widthBase * pos.x) - 5.8),
    y: (3.8 - (heightBase * pos.y))
  }
